      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 grid md:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="order-1 md:order-1 text-center md:text-left space-y-6 pl-4 sm:pl-6 md:pl-12 lg:pl-20">
          ...
          <div className="block md:hidden mt-6">
            <div className="relative w-full flex justify-center">
              <img
                ...
                className="rounded-[1.75rem] shadow-2xl w-full max-w-[420px] mx-auto object-contain drop-shadow-2xl"
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src = 'https://placehold.co/600x500/FFF8E1/5D4037?text=Cookie+Love+Bakery&font=raleway';
                }}
              />
              <div className="absolute -bottom-6 right-4 bg-white px-3 py-1 rounded-2xl shadow-xl border-2 border-gray-900 transform rotate-3 z-20 flex flex-col items-center w-20">
                <span className="font-display font-extrabold text-xl text-amber-800 leading-none">100%</span>
          ...
          <div className="flex flex-row items-center justify-center gap-4 pt-4 w-full max-w-lg mx-auto">
            <button className="flex-1 bg-yellow-400 text-gray-900 font-display font-bold text-lg px-0 py-4 rounded-full shadow-[6px_6px_0px_0px_rgba(93,64,55,1)] hover:shadow-[3px_3px_0px_0px_rgba(93,64,55,1)] transition-all duration-200 border-2 border-gray-900 transform hover:scale-105 min-w-[140px] max-w-[220px] text-center">
              See Menu
            </button>
            ...
            <div className="relative transform hover:scale-105 transition duration-500 ease-out">
              <div className="relative w-full flex justify-center">
                <img 
                  src="/images/hero1.png" 
                  alt="Delicious Cookie Bakery Illustration" 
                  className="rounded-[2rem] md:rounded-[2.5rem] shadow-2xl w-full max-w-[420px] md:max-w-2xl mx-auto object-contain drop-shadow-2xl"
